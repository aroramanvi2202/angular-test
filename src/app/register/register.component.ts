...
export class RegisterComponent {
  ...
  constructor(
    ...
    this.registerForm = this._fb.group({
      firstname: ["", [Validators.required, Validators.pattern("[a-zA-Z]+"), Validators.minLength(5)]],
      lastname: ["", [Validators.required, Validators.pattern("[a-zA-Z]+"), Validators.minLength(5)]],
